---
title: "Hobbesian Absolutism vs. Lockean Constitutionalism"
type: contradiction
...
```mermaid
graph TD
    A["Hobbesian Absolutism"] -->|Sovereignty| B["Absolute, undivided, irrevocable"]
    A -->|Contract| C["Subjects contract among themselves; Sovereign is not a party"]
    A -->|Right to Resist| D["Only when direct self-defense is threatened"]
    E["Lockean Constitutionalism"] -->|Sovereignty| F["Limited, fiduciary trust, divisible"]
    E -->|Contract| G["Agreement between people and sovereign"]
    E -->|Right to Resist| H["Right of revolution when trust is breached"]
```
