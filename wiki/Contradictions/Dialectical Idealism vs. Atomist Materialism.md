---
title: "Dialectical Idealism vs. Atomist Materialism"
type: contradiction
...
```mermaid
graph TD
    A["Dialectical Idealism (Hegel)"] -->|Primary| B["Geist / Mind"]
    A -->|Principle| C["Teleology / Organic Development"]
    D["Atomist Materialism (Democritus)"] -->|Primary| E["Atoms & Void"]
    D -->|Principle| F["Mechanical Necessity / Collision"]
```
