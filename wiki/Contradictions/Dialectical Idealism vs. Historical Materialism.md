---
title: "Dialectical Idealism vs. Historical Materialism"
type: contradiction
...
```mermaid
graph TD
    A["Dialectical Idealism (Hegel)"] -->|Primary Driver| B["Geist (Spirit/Ideas)"]
    A -->|Direction| C["Idea externalizes into Matter, returns to itself as Absolute Spirit"]
    A -->|Superstructure| D["Material institutions are expressions of the Idea"]
    E["Historical Materialism (Marx)"] -->|Primary Driver| F["Material Production & Economics"]
    E -->|Direction| G["Development of productive forces leads to Class Struggle"]
    E -->|Base/Superstructure| H["Economic Base determines Ideological Superstructure"]
```
