...
> MIT-trained computer scientist, video game entrepreneur, and founder of Play Labs @ MIT; author of *The Simulation Hypothesis* (2019), the book-length popular case that reality is a video-game-like simulation.
...
- Both materialist and spiritual accounts converge on "consciousness is really a set of information and a processing of that information."
- Quantum indeterminacy is an optimization technique (conditional rendering).
- The hypothesis is empirically approachable via [[Concepts/Evidence of Computation (Virk)]].
- The hypothesis is "a single framework... that brings together science and religion."

## Contradictions / Open Questions

- > [!warning] The RPG version conflicts with [[Thinkers/Daniel Dennett]]'s deflationary consciousness and with Buddhist anattā (see the concept pages); the NPC alternative conflicts with [[Thinkers/John Searle]]. Virk is a popularizer-synthesist: the vault should weight his physics readings (consciousness-causes-collapse, retrocausality) as contested, not settled.
...
- [[Thinkers/Nick Bostrom]] · [[Arguments/Simulation Argument (Bostrom)]] · [[Thinkers/Ray Kurzweil]] · [[Thinkers/George Berkeley]] · [[Thinkers/Plato]]
