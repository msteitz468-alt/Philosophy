...
```mermaid
graph TD
    A["The Linguistic Turn (Wittgenstein's Legacy)"] --> B["Therapeutic View (Resolute Readers)"]
    A --> C["Pragmatic View (Davidson, Rorty)"]
    
    B --> D["Philosophy is nonsense; aims solely to dissolve puzzles."]
    C --> E["Language is a tool; replaces representationalism with social-practice theory."]
```
