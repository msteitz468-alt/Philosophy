---
title: "Ladder of Love and Form of Beauty (Plato Symposium)"
type: concept
...
```mermaid
graph TD
    A["1. Individual Body (Physical attraction)"] --> B["2. All Beautiful Bodies (Universal physical beauty)"]
    B --> C["3. Beautiful Souls (Moral and mental beauty)"]
    C --> D["4. Institutions and Laws (Social beauty)"]
    D --> E["5. Sciences and Knowledge (Intellectual beauty)"]
    E --> F["6. Form of Beauty (Absolute, transcendent Reality)"]
