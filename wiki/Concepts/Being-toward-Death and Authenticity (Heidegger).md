---
title: "Being-toward-Death and Authenticity (Heidegger)"
type: concept
...
# Being-toward-Death and Authenticity (Heidegger)
> Death individualises Dasein and snatches it from the "endless multiplicity of possibilities" into "the simplicity of its fate."

## Summary

Being-toward-death (*Sein-zum-Tode*) is the keystone of the second division of *Being and Time*, linking [[Concepts/Dasein (Heidegger)|Dasein]]'s practical engagement with the question of its *wholeness* and the grounding of authentic existence. Heidegger does not offer a theory of what happens when one dies; he analyses how the *awareness* of mortality structures Dasein's entire life.

### Death as Existential Structure

Death for Heidegger is not primarily the biological event at life's end (*Ableben* — demise) but *Sterben* — dying understood as an existential structure pervading Dasein's whole existence. "A life without the prospect of death would be a life of perpetual postponement" — immortal Dasein would have no urgency, no need to choose, no finitude to concentrate its possibilities.

Heidegger advances several propositions about death:
- Death is Dasein's **ownmost** possibility — no one can die for me.
- It is **non-relational** — it cuts Dasein off from its relations with others.
- It is **not to be outstripped** — it is the possibility to end all possibilities.
- It **individualises** Dasein: "lays claim to it as an individual Dasein … individualizes Dasein down to itself" (BT 263), conferring "freedom towards death."

Inwood critically probes these propositions, questioning whether death is truly known non-empirically, whether the account is compatible with belief in immortality, whether the neglect of probability is justified, and whether death truly individualises (given burial customs, comradeship in death, and shared mortality).

### Anxiety (Angst)

**Anxiety** (*Angst*) is distinguished from fear (*Furcht*): fear is directed at a specific entity within the world, whereas anxiety has no definite object — it discloses the world *as a whole* and Dasein's thrownness into it. In anxiety, the web of significance collapses; equipment becomes meaningless; Dasein confronts its bare existence. Anxiety is philosophically privileged because it reveals what everyday absorption conceals: Dasein's finitude and the groundlessness of its situation.

### Conscience and Guilt

Conscience (*Gewissen*) operates at two levels in Heidegger:
1. **Ordinary conscience**: prescribes or forbids specific acts — "you ought not to have done that."
2. **Primordial "Conscience"**: calls Dasein to *choose to choose* — to take responsibility for its own being rather than drifting with *das Man*. The call comes from Dasein itself, "from me and yet from beyond me and over me" (BT 275).

Dasein is primordially **Guilty** (*Schuldig*) — not in the moral sense (having committed a wrong) but ontologically: every authentic choice is **groundless** ("Being-the-basis of a nullity"), every decision excludes other possibilities, and every action produces unforeseen consequences. Guilt is ineradicable, not occasional. As Goethe observed: "The agent is always conscienceless."

### Resoluteness (Entschlossenheit)

**Resoluteness** is the authentic mode of disclosedness in which Dasein surveys its life from birth to death, accepts its guilt, and decisively takes over a possibility from its heritage. It is linked etymologically to *Erschlossenheit* (disclosedness) — resolute Dasein is *un-closed*, opened up.
...
- **[[Thinkers/Plato]]**: The allegory of the cave in the *Republic* provides Heidegger's model for resoluteness: the philosopher who returns to the cave has seen the sun and must now live among shadows — resolute Dasein sees its situation clearly but must still dwell in everydayness.
- **[[Thinkers/Aristotle]]**: Actuality is prior to potentiality; Heidegger reverses this for Dasein, whose being-toward-death makes possibility (the not-yet) prior to actuality (the present state).
