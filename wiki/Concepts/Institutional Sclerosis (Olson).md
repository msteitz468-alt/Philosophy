...
```mermaid
graph TD
    A["Long-Term Peace & Stability"] --> B["Time for Groups to Overcome Start-Up Lags"]
    B --> C["Accumulation of Lobbies, Cartels & Unions"]
    C --> D["Distributional Coalitions"]
    D --> E["Rent-Seeking & Entry Barriers"]
    D --> F["Slow Collective Decision-Making"]
    D --> G["Complex Regulations & loop-hole spirals"]
    E & F & G --> H["Institutional Sclerosis"]
    H --> I["Declining Economic Dynamism & Growth"]
```
